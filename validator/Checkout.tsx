...
const validateAndSanitizeCheckoutForm = (data: any, hasStates = true as any) => {
    ...
    const addErrorAndSanitizedData = (fieldName: any, errorContent: any, min: any, max: any, type = '', required: boolean) => {
